...
/*   Updated: 2023/07/20 23:18:31 by lhasmi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	eating_cycle2(t_philosophers *philosophers)
{
	...
	if (!is_philosopher_dead(philosophers))
		philosophers->nb_eat++;
	if (philosophers->data->time_to_die >= philosophers->data->time_to_eat)
		ft_usleep(philosophers->data->time_to_eat);
	else if (philosophers->data->time_to_die < philosophers->data->time_to_eat)
